...
const Student = () => {
  const [page, setPage] = useState("schedual"); // Default page
  ...
  const cards = [
    ...
    { name: "Attendence Rate", icon: <CheckSquare size={32} className="text-purple-500" />, key: "attendence" },
  ];

  return (
    <div className="student p-6">
      {/* Cards */}
